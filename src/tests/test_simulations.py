...
def test_two_body_orbit_euler():
    ...
    pos_mid = states[states.shape[0] // 2, :, 0:2]
    ...
    # Verify bodies have swapped places at t = 0.5T
    assert pos_mid[0][0] == pytest.approx(pos_start[1][0], abs=1e-3)
    assert pos_mid[0][1] == pytest.approx(pos_start[1][1], abs=1e-3)
    assert pos_mid[1][0] == pytest.approx(pos_start[0][0], abs=1e-3)
    assert pos_mid[1][1] == pytest.approx(pos_start[0][1], abs=1e-3)
...
def test_two_body_orbit_barnes_hut():
    ...
    # Verify bodies have swapped places at t = 0.5T
    assert pos_mid[0][0] == pytest.approx(pos_start[1][0], abs=3e-2)
    assert pos_mid[0][1] == pytest.approx(pos_start[1][1], abs=3e-2)
    assert pos_mid[1][0] == pytest.approx(pos_start[0][0], abs=3e-2)
    assert pos_mid[1][1] == pytest.approx(pos_start[0][1], abs=3e-2)
